...
<style>
/* bracketed ordered list */
ol.brackets { list-style: none; padding-left: 1.8em; counter-reset: n; }
ol.brackets > li { counter-increment: n; }
ol.brackets > li::before { content: "[" counter(n) "] "; margin-left: -1.8em; }
</style>

<ol class="brackets">

# **Papers under Review & Working Papers**
<li> <b>Chia-Chun Yang</b>, Craig Froehle, Elizabeth Leenellett, “Effect of Shift Structure on Service-Worker Fatigue: Evidence from Emergency Department Caregivers” (planned for submission to Production and Operations Management in September 2025) </li>
